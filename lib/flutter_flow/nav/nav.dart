...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomePageWidget() : InfoPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: BestServicesPageWidget.routeName,
          path: BestServicesPageWidget.routePath,
          builder: (context, params) => BestServicesPageWidget(),
        ),
        FFRoute(
          name: DetailPageWidget.routeName,
          path: DetailPageWidget.routePath,
          builder: (context, params) => DetailPageWidget(
            serviceReference: params.getParam(
              'serviceReference',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['servicio'],
            ),
            serviceProviderRef: params.getParam(
              'serviceProviderRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['serviceProvider'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BookingSummaryWidget.routeName,
          path: BookingSummaryWidget.routePath,
          builder: (context, params) => BookingSummaryWidget(
            ...
            myService: params.getParam(
              'myService',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['MisServicios'],
            ),
            workerBooking: params.getParam(
              'workerBooking',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['serviceProvider', 'WorkerBooking'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => MapLocationWidget(
            workerBooking: params.getParam(
              'workerBooking',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          builder: (context, params) => FilterPageWidget(
            categoriaSeleccionada: params.getParam(
              'categoriaSeleccionada',
              ParamType.Document,
            ),
          ),
