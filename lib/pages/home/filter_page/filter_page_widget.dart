...
class FilterPageWidget extends StatefulWidget {
  ...
  final CategoriaRecord? categoriaSeleccionada;
        ...
        appBar: AppBar(
          ...
          title: Text(
            valueOrDefault<String>(
              widget!.categoriaSeleccionada?.nombre,
              'categoria',
            ),
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<ServicioRecord>>(
                      stream: queryServicioRecord(
                        queryBuilder: (servicioRecord) => servicioRecord.where(
                          'categoria.name',
                          isEqualTo: widget!.categoriaSeleccionada?.nombre,
                        ),
                      ),
